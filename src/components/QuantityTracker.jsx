    ...
    <div className="min-w-[170px]">
      ...
      <div className="flex items-center gap-1">
        <input
          ...
          placeholder="Amount"
          className="w-16 px-2 py-1 text-xs border border-gray-200 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 outline-none dark:text-gray-100 dark:bg-gray-800"
        />
        <button
          onClick={handleAdd}
          className="p-1.5 bg-blue-50 dark:bg-blue-900/30 text-blue-600 dark:text-blue-400 hover:bg-blue-100 dark:hover:bg-blue-900/50 rounded-lg transition-colors flex-shrink-0"
          title={`Add ${unit}`}
          type="button"
        >
          <Plus size={12} />
