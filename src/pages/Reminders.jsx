          ...
          return (
            <button
              ...
              className={`flex items-center gap-2 px-3.5 py-2 rounded-xl text-xs font-semibold transition-all whitespace-nowrap ${
                active
                  ? 'bg-[#3d7a75] text-white shadow-md shadow-[#3d7a75]/20'
          ...
          {filteredReminders.map((rem) => {
            ...
            return (
              ...
              >
                ...
                {/* Bottom Actions */}
                <div className="pt-3 border-t border-slate-100 dark:border-slate-700/60 flex items-center justify-end">
                  ...
                  <div key={idx} className="flex items-center gap-2">
                    ...
                    <div className="flex-1">
                      <CustomTimePicker
                        ...
                        className="px-3 py-1.5 border border-slate-200 dark:border-slate-600 rounded-xl focus:ring-2 focus:ring-[#3d7a75] outline-none text-xs dark:bg-slate-800 dark:text-slate-100"
                      />
                    </div>
            ...
            <div>
              <div className="flex items-center justify-between mb-1.5">
                ...
                <div className="flex gap-2">
                  <button type="button" onClick={() => setWeekdayPreset('Everyday')} className="text-[10px] text-[#3d7a75] dark:text-[#5fae9e] font-semibold hover:underline">Everyday</button>
                  <button type="button" onClick={() => setWeekdayPreset('Weekdays')} className="text-[10px] text-[#3d7a75] dark:text-[#5fae9e] font-semibold hover:underline">Weekdays</button>
                  <button type="button" onClick={() => setWeekdayPreset('Weekends')} className="text-[10px] text-[#3d7a75] dark:text-[#5fae9e] font-semibold hover:underline">Weekends</button>
                </div>
              </div>
